 ...
 */
public class CanvasBothEdgesSkin extends Border
{
	 ...
	 *  Constructor.
	 */
	public function CanvasBothEdgesSkin()
	{
		super();
	}
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		graphics.moveTo(w-1-2-3,1+0-3);
		graphics.lineTo(1+0-3,h-1-2-3);
		graphics.moveTo(w-1-1-3,1+1-3);
		graphics.lineTo(1+1-3,h-1-1-3);
		graphics.moveTo(w-1-0-3,1+2-3);
		graphics.lineTo(1+2-3,h-1-0-3);
